...
def detect(save_img=False):
    source, weights, view_img, save_txt, imgsz, trace, blur_classes = opt.source, opt.weights, opt.view_img, opt.save_txt, opt.img_size, not opt.no_trace, opt.blur_classes
